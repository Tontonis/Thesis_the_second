...
24 Conductors, Alternating Length & 36 & 28 \\ \hline %shortened
24 Conductors, Tapered Length & $P_{loss,50ns}$ (W), $t_{b}=1$ns & $P_{loss,25ns}$ (W), $t_{b}=1$ns \\ \hline %n shortened
24 Conductors, Alternating and Tapered & $P_{loss,50ns}$ (W), $t_{b}=1$ns & $P_{loss,25ns}$ (W), $t_{b}=1$ns \\ \hline %no shortened
...
24 Conductors, Final Design & 37 & 28 \\ %Shortened Version
\end{tabular}
\end{center}
\end{table}
