...
\begin{center}
\subfigure[]{
\includegraphics[width=0.62\textwidth]{LHC_Collimation_Upgrades/figures/longitudinal.pdf}
\label{fig:phase-2-long}
}\\
\subfigure[]{
\includegraphics[width=0.62\textwidth]{LHC_Collimation_Upgrades/figures/horizDipolar.pdf}
\label{fig:phase-2-horzdip}
}\\
\subfigure[]{
\includegraphics[width=0.62\textwidth]{LHC_Collimation_Upgrades/figures/vertDipolar.pdf}
