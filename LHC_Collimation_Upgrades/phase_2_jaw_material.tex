...
\caption{The impedances of different jaw materials for the phase 2 secondary collimators. \subref{fig:phase-2-long} The longitudinal impedance, \subref{fig:phase-2-horzdip} the horizontal dipolar impedance, \ref{fig:phase-2-vertdip}, the vertical dipolar impedance, \subref{fig:phase-2-horzquad} the horizontal quadrupolar impedance and \subref{fig:phase-2-vertquad} the vertical quadrupolar impedance per unit length.}
