...
\begin{center}
\subfigure[]{
\includegraphics[width=0.4\textwidth]{Beam_Coupling_Impedance_Reduction_Techniques/figures/stepTransitionTaper.png}
\label{fig:taper_geometry}
}\\
\subfigure[]{
\includegraphics[width=0.65\textwidth]{Beam_Coupling_Impedance_Reduction_Techniques/figures/impedanceTaper.pdf}
\label{fig:taper_impedance}
}\\
\subfigure[]{
\includegraphics[width=0.65\textwidth]{Beam_Coupling_Impedance_Reduction_Techniques/figures/impedanceTaperZn.pdf}
\label{fig:taper_impedance_Zn}
}
\end{center}
\caption{An example pillbox structure with and without a tapered transition region \subref{fig:taper_geometry}, in this case with the taper of 15$^{\circ}$. The resulting imaginary component of the longitudinal impedances are shown in \subref{fig:taper_impedance}, with $Z/n$ shown in \subref{fig:taper_impedance_Zn}, as these are the most significant for beam stability.}
\label{fig:taper_ex}
\end{figure}
