\section{Serigraphy on Kicker Magnets}
...
\begin{figure}
\subfigure[]{
\includegraphics[width=0.6\textwidth]{Beam_Coupling_Impedance_Reduction_Techniques/figures/mke-serigraphy-diagram.png}
...
\begin{center}
\subfigure[]{
\includegraphics[width=0.6\textwidth]{Beam_Coupling_Impedance_Reduction_Techniques/figures/Printed_comparison_paper.jpg}
\label{fig:mke_impedance}
}
\end{center}
\caption{An example of serigraphy in the SPS Extraction Kicker Magnets (SPS-MKE). The layout of the interleaved fingers is shown in \subref{fig:mke_layout} and the actual serigraphed ferrites in \subref{fig:mke_picture}. A comparison of the measured real component of the longitudinal beam coupling impedance with and without the serigraphy is shown in \subref{fig:mke_impedance}.}
